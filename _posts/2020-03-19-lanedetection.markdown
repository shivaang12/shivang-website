...
permalink: /projects/lanedetection.html
---
...
{% include images.html url="/images/lane-detection-simple.jpg" description="" width="600" %}
...
{% include images.html url="/images/lane-detection-grayscale.jpg" description="" width="600" %}
...
{% include images.html url="/images/lane-detection-canny.jpg" description="" width="600" %}
...
{% include images.html url="/images/lane-detection-roi-draw.jpg" description="" width="600" %}
...
{% include images.html url="/images/lane-detection-roi.jpg" description="" width="600" %}
...
{% include images.html url="/images/lane-detection-hough-lines-all.jpg" description="" width="600" %}
...
{% include images.html url="/images/lane-detection-main.jpg" description="" width="600" %}
...
{% include images.html url="/images/lane-detection-pipeline.png" description="" width="600" %}
